...
Public Class Summary
    ...
    Public Sub UpdateSummary(CHALLANID As Integer, liablePerson As String, issueDate As DateTime, returnDate As DateTime, receiver As String, products As List(Of (String, Integer, String, String, Integer)), COMBO As String)
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString(Label46.Text, font, Brushes.Black, leftMargin, topMargin + 160)
        ...
        e.Graphics.DrawString($"Through: {Label45.Text}", font, Brushes.Black, leftMargin + 700, yPos)
        yPos += 20
        e.Graphics.DrawLine(linePen, leftMargin, yPos, rightMargin, yPos)
